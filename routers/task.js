...
router.get('/todo/completedTask/', sortByNoOfCompletedTaskForallUsers); // this api take query in url ex: url?order=1| -1
router.get('/todo/MaxCompletedTask/', UsersCompletedMaxTask); // this api take query in url ex: url?order=1| -1
